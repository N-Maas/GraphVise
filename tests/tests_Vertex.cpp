...
TEST(VertexTest, CheckGetter) {
    ...
    EXPECT_NEAR(vertex.getVec4().x, 1, 0.0001);    //Value of the Default-Group
    EXPECT_NEAR(vertex.getVec4().y, 0, 0.0001);  //Value of the Default-Group
    EXPECT_NEAR(vertex.getVec4().z, 0, 0.0001);  //Value of the Default-Group
    EXPECT_EQ(vertex.getVec4().w, 1);    //Value of the Default-Group
}
