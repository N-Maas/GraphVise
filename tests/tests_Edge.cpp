...
TEST(EdgeTest, CheckGetter) {
    ...
    EXPECT_NEAR(edge1.getVec4().x, 1, 0.0001);    //Value of the Default-Group
    EXPECT_NEAR(edge1.getVec4().y, 0.60784316, 0.0001);  //Value of the Default-Group
    EXPECT_NEAR(edge1.getVec4().z, 0, 0.0001);  //Value of the Default-Group
    EXPECT_EQ(edge1.getVec4().w, 1);    //Value of the Default-Group
}
